...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    //private AnimationDrawable refreshingCat;
    // 默认下拉头
...
//        loadingCat = (AnimationDrawable) getResources().getDrawable(R.drawable.loading_cat);
//        refreshingCat = (AnimationDrawable) getResources().getDrawable(R.drawable.loading_cat);
        // 添加匀速转动动画
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case RELEASE_TO_REFRESH:
                ...
                // 释放刷新状态
                if (null == customRefreshView) {
                    refreshStateTextView.setText("释放立即加载");
...
//                    refreshingView.setBackgroundDrawable(refreshingCat);
//                    refreshingCat.start();
...
//                    loadingView.setBackgroundDrawable(loadingCat);
//                    loadingCat.start();
