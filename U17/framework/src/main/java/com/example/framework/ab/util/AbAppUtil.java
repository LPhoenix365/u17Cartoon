...
//		context.startActivity(intent);
	 ...
	 * 启动service
	 */
	public static void startStepService(Context context,String action,String packages) {
		Intent intent = new Intent();
	 ...
	 * 绑定service
	 */
	public static void bindStepService(Context context,String action,String packages,ServiceConnection conn) {
		Intent intent = new Intent();
		intent.setAction(action);
		intent.setPackage(packages);
