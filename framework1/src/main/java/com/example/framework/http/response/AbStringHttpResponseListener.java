...
import com.example.framework.http.ProgressDialogHandler;
import com.example.framework.http.abutil.AbLogUtil;
import com.example.framework.http.request.AbHttpClient;
import com.example.framework.http.request.HttpRequestTask;
...
//			mProgressDialogHandler = null;
     ...
     */
    public abstract <T> void onSuccess(int statusCode, String content);
